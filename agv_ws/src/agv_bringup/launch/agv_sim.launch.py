...
def generate_launch_description():
    ...
    return LaunchDescription([
        ...
        Node(package='agv_mission', executable='mission_manager', parameters=[os.path.join(bringup, 'config', 'mission.yaml')]),
        Node(package='agv_control', executable='safety_controller', parameters=[os.path.join(bringup, 'config', 'mission.yaml')]),
